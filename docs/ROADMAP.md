...
| 3 | `replicant-streaming` | `pgoutput` proto ≥ 2 in-progress-transaction streaming, for single transactions too large to buffer to Commit (v1 buffers per-txn). | Core (shipped) | Not started |
