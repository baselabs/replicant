...
> **Status:** 1.2.0 is the latest release published on Hex and HexDocs (tagged `v1.2.0`). It
> adds proven PostgreSQL 15–18 support, the typed
> `handle_slot_origin/2` callback, typed-shape telemetry validation, and a value-safety
> regression suite (see CHANGELOG `[1.2.0]`).
> Replicant owns
